...
$db->ejecutaSQL($insertar_c);

echo "<br><br><div class='alert alert-success' align='center'><h2>Cliente registrado con exito</h2></div>";
header("refresh:3; GAYOSSO_CARDS.html");
